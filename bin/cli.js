...
// const myChalk = import('../utils/chalk.js');
import ora from 'ora';
...
//获取package.json的版本号
program.version('1.3.1', '--version', '输出版本号');
//解析命令行的指令，必须要加上，不然打印不出信息
program
    .command('vue')
    .arguments('<projectName>')
    .description('自定制创建vue2项目')
    .action((projectName) => {
        if (!projectName) {
                    ...
                    if (v_a['vueVersion'] === 'vue2') {
                        ...
                        const templates = {
                            v3ct_pinia_less: {
                                ...
                                downloadUrl:
                                    'github:odinsam/v2ct_vuex_less#master',
                                description:
                            ...
                            .then((answers) => {
                                ...
                                const templates = {
                                    v3ct_pinia_less: {
                                        ...
                                        // 仓库下载地址，格式为：仓库地址:用户名/仓库名#分支名
                                        downloadUrl:
                                            'github:odinsam/v3ct_pinia_less#master',
                                        description:
